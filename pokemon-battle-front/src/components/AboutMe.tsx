  ...
  return (
    <div className="about-me-container">
      ...
      <section className="section">
        ...
        <h2>Teacher</h2>
<p>
  <a href="https://cite.dpu.ac.th/ResumeDean.html" target="_blank" rel="noopener noreferrer">
...
<p>วิทยาลัยวิศวกรรมศาสตร์และเทคโนโลยี</p>
    ...
    <a href="https://github.com/ARRUKlib/Game-Pokemon-Battle-Card" target="_blank" rel="noopener noreferrer">
      GitHub
    </a>
  </div>
...
<div className="diagram-container">
  <img 
    src='https://github.com/user-attachments/assets/977a754c-3da4-410d-a662-ade6249b8d1a' 
    alt='DiagramPokemon' 
